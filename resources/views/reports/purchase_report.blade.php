      ...
      $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
        ...
        function purchase_datatable(start_date ='', end_date ='', Ref ='',provider_id ='',warehouse_id ='', payment_statut =''){
            ...
            var table = $('#purchase_table').DataTable({
               ...
               console.log('Deep Ledger Rows:');
json.data.forEach(row => {
    console.log(`Ref: ${row.Ref}, Debit: ${row.debit}, Credit: ${row.credit}, Running: ${row.running_balance}`);
});

                return json.data; // normal DataTable processing
            },
                            ...
                            title: function(){
                              return 'Report Purchases';
                               ...
                               action: function(e, dt, node, config) {
                                // get filter values
                                var start_date = $('#reportrange').data(
                                    'daterangepicker').startDate.format(
                                    'YYYY-MM-DD');
                                var end_date = $('#reportrange').data('daterangepicker')
                                ...
                                var url = '/purchase_ledger/export?start_date=' +
                                    start_date +
                                    '&end_date=' + end_date +
                                    '&Ref=' + Ref +
