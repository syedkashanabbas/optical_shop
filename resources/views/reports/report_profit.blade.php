   ...
   <div class="col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <div class="card card-icon-big text-center mb-30">
                    <div class="card-body">
                        <i class="i-Tag-2"></i>
                        <div class="content">
                            <p class="text-muted mt-2 mb-0">(@{{infos.discount_count}}) {{ __('Total Discounts') }}</p>
                            <p class="text-danger text-24 line-height-1 mb-2">@{{infos.total_discounts}}</p>
                        </div>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Fixed + Percentage Discounts</small>
                    </div>
                </div>
            </div>
