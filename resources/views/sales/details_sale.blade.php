...
<div class="row mt-5 signature-row">
  <div class="col-md-6 text-center signature-col">
    <p class="signature-line">&nbsp;</p>
    <h6 class="signature-label">Authorized Signature</h6>
  </div>
  <div class="col-md-6 text-center signature-col">
    <p class="signature-line">&nbsp;</p>
    <h6 class="signature-label">Customer Signature</h6>
  </div>
</div>
...
<script>
  function printDiv() {
    ...
    @media print {
      @page { size: 11in 17in; margin: 20mm; }
      ...
      /* Limit the line width for signature */
      .signature-line {
        border-bottom: 1px dotted #000;
        width: 80%;
