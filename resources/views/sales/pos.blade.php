...
<head>
  ...
  <title>Rubi Optical - Ultimate Inventory Management System with POS</title>
         ...
         Submit_Payment() {
              this.$refs.add_payment_sale.validate().then(success => {
                  if (!success) {
                   toastr.error('Please fill out the form correctly');
                         ...
                         toastr.error('Payment amount cannot exceed total');
          ...
          Verified_paidAmount() {
              if (isNaN(this.payment.montant)) {
                 ...
                 toastr.warning('Payment amount cannot exceed total');
                  this.payment.montant = 0;
              } 
          },
