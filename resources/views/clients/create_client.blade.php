                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" step="0.01" v-model="client.opening_balance" class="form-control" 
                                   id="opening_balance" placeholder="{{ __('translate.Enter_Opening_Balance') }}">
                            <span class="error" v-if="errors && errors.opening_balance">
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            Create_Client() {
                ...
                self.data.append("opening_balance", self.client.opening_balance);
