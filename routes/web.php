...
use App\Exports\SalesLedgerExport;
...
Route::get('/purchase_ledger/export', function (Request $request) {
    $filters = [
    ...
    return Excel::download(new LedgerExport($filters), 'purchase_report_ledger.xlsx');
});


Route::get('/sales_ledger/export', function (Request $request) {
    $filters = [
        'start_date' => $request->query('start_date'),
        'end_date' => $request->query('end_date'),
        'Ref' => $request->query('Ref'),
    ...
    return Excel::download(new SalesLedgerExport($filters), 'sales_ledger_export.xlsx');
});
