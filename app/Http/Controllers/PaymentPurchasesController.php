...
public function store(Request $request) 
{
    ...
    \DB::transaction(function () use ($request) {
        ...
        $supplier_id = $purchase->provider_id; // 👈 consider this as supplier ID
        ...
        if ($supplier_id) {
            ...
            \Log::warning("⚠️ Provider ID is missing for Purchase ID: {$purchase->id}. Provider ledger not recorded.");
        }
