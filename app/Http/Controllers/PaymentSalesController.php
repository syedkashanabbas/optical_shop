            ...
            try {
                ...
                if ($payment->account_id) {
                    ...
                    if ($old_account) {
                        ...
                        // ❌ Remove old account ledger
                        \App\Services\AccountLedgerService::deleteLog(
                            $payment->account_id,
                            'sale_payment',
                            $payment->Ref
                        );
                ...
                // ❌ Remove old client ledger
                \App\Services\ClientLedgerService::deleteLog(
                    $sale->client_id,
                    'sale_payment',
                    $payment->Ref
                );
