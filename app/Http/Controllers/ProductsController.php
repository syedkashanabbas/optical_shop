...
class ProductsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //     'user' => auth()->user()->with('assignedWarehouses')->get()->toArray(),
        // ]);
        ...
        if ($user_auth->can('products_add')) {
            ...
            $productRules = [
                ...
                'cost'         => Rule::requiredIf($request->type == 'is_single' || $request->type == 'is_service'),
            ...
            \DB::transaction(function () use ($request) {
                ...
                Product::syncProductQty($Product);
            }, 10);
        ...
        if ($user_auth->can('products_edit')) {
            ...
            try {
                ...
                \DB::transaction(function () use ($request, $id) {
                    ...
                    Product::syncProductQtyByReq($Product, $request);
                }, 10);
    ...
    public function Products_by_Warehouse(request $request, $id)
    {
        ...
        foreach ($product_warehouse_data as $product_warehouse) {
            ...
            if ($product_warehouse->product_variant_id) {
                ...
                $product_price = $product_warehouse['productVariant']?->price ?? 0;
            } else {
                ...
                $product_price = $product_warehouse['product']?->price ?? 0;
            }
